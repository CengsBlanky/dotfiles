...
require("lazy").setup({
  ...
  },
  {
    ...
    opts= {
      ...
      ensure_installed = { 'awk_ls', 'bashls', 'clangd', 'dockerls', 'lua_ls', 'marksman', 'ruff', 'basedpyright', 'djlsp', 'zls', 'gopls', 'jdtls', 'html', 'cssls', 'vtsls', 'jsonls', 'svelte', 'emmet_language_server', 'expert', 'vue_ls', },
    },
    dependencies = {
      {
