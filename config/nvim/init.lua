...
require("lazy").setup({
  ...
  },
  {
    ...
    opts= {
      ...
      ensure_installed = { 'awk_ls', 'bashls', 'clangd', 'dockerls', 'lua_ls', 'marksman', 'basedpyright', 'zls', 'gopls', 'jdtls', 'ruff', 'html', 'cssls', 'vtsls', 'jsonls', 'svelte', 'htmx', 'emmet_language_server', },
    },
    dependencies = {
      {
