...
require("lazy").setup({
  ...
  },
  {
    ...
    opts= {
      ...
      ensure_installed = { 'awk_ls', 'bashls', 'clangd', 'dockerls', 'lua_ls', 'marksman', 'ruff', 'basedpyright', 'djlsp', 'zls', 'gopls', 'jdtls', 'html', 'cssls', 'vue_ls', 'vtsls', 'jsonls', 'svelte', 'emmet_language_server', 'expert' },
    },
    dependencies = {
      {
