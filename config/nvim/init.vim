...
require'nvim-treesitter.configs'.setup {
  ensure_installed = { "c", "cpp", "java", "go", "javascript", "typescript", "css", "python", "markdown", "bash", "toml", "yaml"}, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
