...
require'nvim-treesitter.configs'.setup {
  ensure_installed = { "bash", "dart", "c", "diff", "java", "kotlin", "dockerfile", "go", "html", "css", "javascript", "svelte", "json", "lua", "markdown", "markdown_inline", "comment", "python", "rust", "sql", "typescript", "yaml", "toml" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
