...
require'nvim-treesitter.configs'.setup {
  ensure_installed = { "bash", "dart", "c", "diff", "java", "dockerfile", "go", "help", "html", "javascript", "json", "lua", "markdown", "markdown_inline", "comment", "python", "rust", "sql", "typescript", "yaml" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
