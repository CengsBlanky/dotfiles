...
set_hl(0, "@markup.heading.1.markdown", { fg = "#ee99a0", bold = true, reverse = true })
set_hl(0, "@markup.heading.2.markdown", { fg = "#f5a97f", bold = true, reverse = true })
set_hl(0, "@markup.heading.3.markdown", { fg = "#eed49f", bold = true, reverse = true })
set_hl(0, "@markup.heading.4.markdown", { fg = "#a6da95", bold = true, reverse = true })
set_hl(0, "@markup.heading.5.markdown", { fg = "#7dc4e4", bold = true, reverse = true })
set_hl(0, "@markup.heading.6.markdown", { fg = "#b7bdf8", bold = true, reverse = true })
